...
const (
	...
	DISK_REPLACEMENT_STATUS_FAILED    = "Failed"
	DISK_REPLACEMENT_FILTER_ALL       = "all"
	DISK_REPLACEMENT_FILTER_STATUS    = "status"
	DISK_REPLACEMENT_FILTER_DEVICE    = DISK_FILTER_DEVICE
	DISK_REPLACEMENT_FILTER_SERVICE   = DISK_FILTER_SERVICE
	DISK_REPLACEMENT_INIT_PROGRESS    = "0"
	DISK_REPLACEMENT_INIT_STATUS      = DISK_REPLACEMENT_STATUS_RUNNING
	DISK_REPLACEMENT_NEW_DISK_DEVICE  = "disk_replacement_new_disk"
	DISK_REPLACEMENT_FORMER_DISK_UUID = "disk_replacement_former_disk_uuid"
